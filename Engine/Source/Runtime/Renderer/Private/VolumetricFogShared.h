...
struct FVolumetricFogIntegrationParameterData
{
	...
	// Only valid when using ray tracing
	FRDGTexture* VoxelShadowInfo;
};
...
public:
	...
	void Bind(const FShaderParameterMap& ParameterMap)
	{
		...
		VoxelShadowInfo.Bind(ParameterMap, TEXT("VoxelShadowInfo"));
...
private:
	...
	LAYOUT_FIELD(FRWShaderParameter, VoxelShadowInfo)
