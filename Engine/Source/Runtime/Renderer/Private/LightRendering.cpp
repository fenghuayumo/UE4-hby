	...
	const FHairStrandsRenderingData* HairDatas)
{
...

	{
		...
		if (SortedLightSet.ComplexLightsStart > AttenuationLightStart)
		{
			...
			SET_DWORD_STAT(STAT_NumSampledLights, SampledLights.Num());

			RenderSampledDirectLighting(GraphBuilder, SceneTexturesUniformBuffer, SampledLights, HairDatas, SceneColorTexture, LightingChannelsTexture);
