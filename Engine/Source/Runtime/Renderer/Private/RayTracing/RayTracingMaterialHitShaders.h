...
protected:
	...
	static bool ExcludeTranslucentsFromShadows();
		...
		const ShaderElementDataType& ShaderElementData)
	{
		...
		const bool bShadowOverride = ExcludeTranslucentsFromShadows() && MaterialResource.GetBlendMode() == EBlendMode::BLEND_Translucent;
		...
		SharedCommand.bCastRayTracedShadows = MeshBatch.CastRayTracedShadow && MaterialResource.CastsRayTracedShadows() && !bShadowOverride;;
