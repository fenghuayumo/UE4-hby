...
{
public:
	FStaticMeshBatchRelevance(const FStaticMeshBatch& StaticMesh, float InScreenSize, bool InbSupportsCachingMeshDrawCommands, bool InbUseSkyMaterial, bool bInUseSingleLayerWaterMaterial, bool bInUseAnisotropy, bool bInUsesWorldPositionOffset, ERHIFeatureLevel::Type FeatureLevel)
		: Id(StaticMesh.Id)
		...
		, bUsesWorldPositionOffset(bInUsesWorldPositionOffset)
	{
	}
	...
	/** Cached from material to see if this surface modifies world position offset **/
