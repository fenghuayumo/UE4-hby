...
#if RHI_RAYTRACING
	const bool RayTraced = PrimitiveSceneProxy && PrimitiveSceneProxy->IsRayTracingRelevant() && PrimitiveSceneProxy->IsVisibleInRayTracing();
#else
	const bool RayTraced = false;
#endif
