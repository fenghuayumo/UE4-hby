...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("Ray tracing instanced static meshes"), STAT_RayTracingInstancedStaticMeshes, STATGROUP_SceneRendering, RENDERCORE_API);
...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("Num sampled"), STAT_NumSampledLights, STATGROUP_LightRendering, RENDERCORE_API);
