...
class ENGINE_API URendererSettings : public UDeveloperSettings
{
	...
	*/
	...
	UPROPERTY(config, EditAnywhere, Category = RayTracing, meta = (
		...
		ConsoleVariable = "r.RayTracing.HybridTranslucencySupport", DisplayName = "Hybrid Translucency",
		ToolTip = "Enable Hybrid Translucency capabilities.  Requires 'Ray Tracing' before project is allowed to set this.",
		ConfigRestartRequired = true))
		uint32 bEnableHybridTranslucency : 1;
