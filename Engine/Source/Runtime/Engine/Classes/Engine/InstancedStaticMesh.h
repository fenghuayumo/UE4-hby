...
#if RHI_RAYTRACING
	/** Get cached CPU-friendly instance AABB */
	const TArray<FBox>& GetPerInstanceAABBs();
#endif
...
public:
	...
	virtual bool UseRayTracingShadowBias() const override;
