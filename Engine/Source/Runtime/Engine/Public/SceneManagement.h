...
public:
	...
	inline bool SupportsSampledLighting() const { return bSupportSampledLighting; }
...
protected:
	...
	/** Whether the light supports ray traced sampled lighting (when available). */
	const uint8 bSupportSampledLighting : 1;
...
struct FRayTracingDynamicGeometryUpdateParams
{
	...
	uint32 InstanceId = 0; 
	FMatrix WorldToInstance = FMatrix::Identity;
};
